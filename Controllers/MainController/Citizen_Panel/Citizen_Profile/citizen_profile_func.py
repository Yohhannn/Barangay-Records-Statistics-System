...
class citizen_profile_func(base_file_func):
    def __init__(self, login_window, emp_first_name, stack):
        ...
        self.stack = stack
        self.cp_profile_screen = self.load_ui("Views/MainPages/CitizenPanelPages/cp_citizenprofile.ui")
    ...
    def setup_profile_ui(self):
        ...
        self.cp_profile_screen.btn_returnToCitizenPanelPage.setIcon(QIcon('Resources/FuncIcons/img_return.png'))
        self.cp_profile_screen.cp_CitizenName_buttonSearch.setIcon(QIcon('Resources/FuncIcons/icon_search_w.svg'))
        self.cp_profile_screen.cp_citizen_button_register.setIcon(QIcon('Resources/FuncIcons/icon_add.svg'))
        self.cp_profile_screen.cp_citizen_button_update.setIcon(QIcon('Resources/FuncIcons/icon_edit.svg'))
        self.cp_profile_screen.cp_citizen_button_remove.setIcon(QIcon('Resources/FuncIcons/icon_del.svg'))
        self.cp_profile_screen.profileList_buttonFilter.setIcon(QIcon('Resources/FuncIcons/icon_filter.svg'))
    ...
    def show_register_citizen_part_01_popup(self):
        self.part1_popup = load_popup("Views/PopUp/Screen_CitizenPanel/ScreenCitizenProfile/register_citizen_part_01.ui", self)
        ...
        self.part1_popup.register_buttonPrev.setIcon(QIcon('Resources/FuncIcons/icon_arrow_prev'))
        self.part1_popup.register_buttonConfirmPart1_NextToPart2.setIcon(QIcon('Resources/FuncIcons/icon_arrow_next'))
    ...
    def validate_part1_fields(self):
        ...
        if not self.part1_popup.register_citizen_date_dob.date().isValid():
            self.part1_popup.register_citizen_date_dob.setStyleSheet(
                "border: 1px solid red; border-radius: 5px; padding: 5px; background-color: rgb(239, 239, 239)"
            )
    ...
    def setup_image_handlers(self, popup):
        popup.uploadButton.setIcon(QIcon("Resources/Icons/icon_upload_image.svg"))
        popup.captureButton.setIcon(QIcon("Resources/Icons/icon_camera.svg"))
    ...
    def show_register_citizen_part_02_popup(self, part_one_popup):
        ...
        self.part2_popup = load_popup("Views/PopUp/Screen_CitizenPanel/ScreenCitizenProfile/register_citizen_part_02.ui", self)
        ...
        self.part2_popup.register_buttonReturnToPart1_FromPart2.setIcon(QIcon('Resources/FuncIcons/icon_arrow_prev'))
        self.part2_popup.register_buttonConfirmPart2_NextToPart3.setIcon(QIcon('Resources/FuncIcons/icon_arrow_next'))
    ...
    def show_register_citizen_part_03_popup(self, part_two_popup):
        ...
        self.part3_popup = load_popup("Views/PopUp/Screen_CitizenPanel/ScreenCitizenProfile/register_citizen_part_03.ui", self)
        ...
        self.part3_popup.register_buttonReturnToPart2_FromPart3.setIcon(QIcon('Resources/FuncIcons/icon_arrow_prev'))
        self.part3_popup.register_buttonConfirmPart3_SaveForm.setIcon(QIcon('Resources/FuncIcons/icon_confirm'))
        if hasattr(self, 'citizen_data'):
