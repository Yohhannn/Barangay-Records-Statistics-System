...
class institutions_func(base_file_func):
    def __init__(self, login_window, emp_first_name, stack):
        ...
        self.stack = stack
        self.institutions_screen = self.load_ui("Views/MainPages/institutions.ui")
        self.setup_ui()
    ...
    def setup_ui(self):
        ...
        self.institutions_screen.nav_imageLogo.setPixmap(QPixmap("Resources/Images/logo_brgyClear.png"))
        self.institutions_screen.nav_buttonDashboard.setIcon(QIcon('Resources/Icons/icon_dashboard.svg'))
        self.institutions_screen.nav_buttonCitizenPanel.setIcon(QIcon('Resources/Icons/icon_citizenpanel.svg'))
        self.institutions_screen.nav_buttonStatistics.setIcon(QIcon('Resources/Icons/icon_statistics.svg'))
        self.institutions_screen.nav_buttonInstitutions.setIcon(QIcon('Resources/Icons/icon_institutions.svg'))
        self.institutions_screen.nav_buttonTransactions.setIcon(QIcon('Resources/Icons/icon_transaction.svg'))
        self.institutions_screen.nav_buttonHistoryRecords.setIcon(QIcon('Resources/Icons/icon_historyrecord_closed.svg'))

        self.institutions_screen.nav_buttonAdminPanel.setIcon(QIcon('Resources/Icons/icon_adminoverview_off.svg'))
        self.institutions_screen.nav_buttonActivityLogs.setIcon(QIcon('Resources/Icons/icon_activitylogs_off.svg'))
        self.institutions_screen.nav_isLocked.setIcon(QIcon('Resources/Icons/icon_isLocked.svg'))

        self.institutions_screen.inst_ButtonCategory_Business.setIcon(QIcon('Resources/Images/img_category_business.png'))
        self.institutions_screen.inst_ButtonCategory_Infrastructure.setIcon(QIcon('Resources/Images/img_category_infrastructure.png'))
    ...
    def goto_business_panel(self):
        ...
        if not hasattr(self, 'business'):
            from Controllers.MainController.Institutions.Business.business_func import business_func
    ...
    def goto_infrastructure_panel(self):
        ...
        if not hasattr(self, 'infrastructure'):
            from Controllers.MainController.Institutions.Infrastructure.infrastructure_func import infrastructure_func
