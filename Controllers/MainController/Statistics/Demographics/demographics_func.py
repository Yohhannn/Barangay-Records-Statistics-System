...
class demographics_func(base_file_func):
    def __init__(self, login_window, emp_first_name, stack):
        ...
        self.stack = stack
        self.stat_demo_screen = self.load_ui("Views/MainPages/StatisticPages/demographic.ui")
        self.setup_demo_ui()
    ...
    # Set images and icons
        self.stat_demo_screen.btn_returnToStatisticsPage.setIcon(QIcon('Resources/FuncIcons/img_return.png'))
        self.stat_demo_screen.icon_male.setIcon(QIcon('Resources/Icons/icon_male.png'))
        self.stat_demo_screen.icon_female.setIcon(QIcon('Resources/Icons/icon_female.png'))
