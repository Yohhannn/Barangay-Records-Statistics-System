...
class education_func(base_file_func):
    def __init__(self, login_window, emp_first_name, stack):
        super().__init__(login_window, emp_first_name)
        self.stack = stack
        self.stat_edu_screen = self.load_ui("Views/MainPages/StatisticPages/education.ui")
        self.setup_edu_ui()
    ...
    # Set images and icons
        self.stat_edu_screen.btn_returnToStatisticsPage.setIcon(QIcon('Resources/FuncIcons/img_return.png'))
