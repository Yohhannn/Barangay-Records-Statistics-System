...
class employment_func(base_file_func):
    def __init__(self, login_window, emp_first_name, stack):
        super().__init__(login_window, emp_first_name)
        self.stack = stack
        self.stat_emp_screen = self.load_ui("Views/MainPages/StatisticPages/employment.ui")
        self.setup_emp_ui()
    ...
    # Set images and icons
        self.stat_emp_screen.btn_returnToStatisticsPage.setIcon(QIcon('Resources/FuncIcons/img_return.png'))
