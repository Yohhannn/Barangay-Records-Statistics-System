...
class infrastructure_func(base_file_func):
    def __init__(self, login_window, emp_first_name, stack):
        ...
        self.stack = stack
        self.stat_infra_screen = self.load_ui("Views/MainPages/StatisticPages/infrastructure.ui")
        self.setup_infra_ui()
    ...
    # Set images and icons
        self.stat_infra_screen.btn_returnToStatisticsPage.setIcon(QIcon('Resources/FuncIcons/img_return.png'))
