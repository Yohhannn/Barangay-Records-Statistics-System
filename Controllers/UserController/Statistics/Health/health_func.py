...
class health_func(BaseFileController):
    ...
    def _setup_time(self):
        self.timer = QTimer(self.stat_health_screen)
    ...
    def _setup_date(self):
        ...
        self.stat_health_screen.text_date.setText(f"{formatted_date} - {day_of_week}")

        # Update time label
        formatted_time = current_datetime.toString("h:mm:ss AP")
        self.stat_health_screen.text_time.setText(formatted_time)
