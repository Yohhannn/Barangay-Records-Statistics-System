...
class socioeconomic_func(BaseFileController):
    def __init__(self, login_window, emp_first_name, stack):
        ...
        self.stack = stack
        self.stat_socioeconomic_screen = self.load_ui("Resources/UIs/MainPages/StatisticPages/socioeconomic.ui")
    ...
    # Set images and icons
        self.stat_socioeconomic_screen.btn_returnToStatisticsPage.setIcon(QIcon('Resources/Icons/FuncIcons/img_return.png'))
