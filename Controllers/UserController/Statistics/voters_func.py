...
class voters_func(BaseFileController):
    def __init__(self, login_window, emp_first_name, stack):
        ...
        self.stack = stack
        self.stat_voters_screen = self.load_ui("Resources/UIs/MainPages/StatisticPages/voters.ui")
    ...
    # Set images and icons
        self.stat_voters_screen.btn_returnToStatisticsPage.setIcon(QIcon('Resources/Icons/FuncIcons/img_return.png'))
