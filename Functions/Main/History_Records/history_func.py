...
class history_func(base_file_func):
    def __init__(self, login_window, emp_first_name, stack):
        ...
        self.stack = stack
        self.history_screen = self.load_ui("UI/MainPages/historyrecords.ui")
    ...
    def setup_history_ui(self):
        ...
        self.history_screen.nav_imageLogo.setPixmap(QPixmap("Assets/Images/logo_brgyClear.png"))
        self.history_screen.nav_buttonDashboard.setIcon(QIcon('Assets/Icons/icon_dashboard.svg'))
        self.history_screen.nav_buttonCitizenPanel.setIcon(QIcon('Assets/Icons/icon_citizenpanel.svg'))
        self.history_screen.nav_buttonStatistics.setIcon(QIcon('Assets/Icons/icon_statistics.svg'))
        self.history_screen.nav_buttonInstitutions.setIcon(QIcon('Assets/Icons/icon_institutions.svg'))
        self.history_screen.nav_buttonTransactions.setIcon(QIcon('Assets/Icons/icon_transaction.svg'))
        self.history_screen.nav_buttonHistoryRecords.setIcon(QIcon('Assets/Icons/icon_historyrecord.svg'))

        # SET NAVIGATION ADMIN ASSETS
        self.history_screen.nav_buttonAdminPanel.setIcon(QIcon('Assets/Icons/icon_adminoverview_off.svg'))
        self.history_screen.nav_buttonActivityLogs.setIcon(QIcon('Assets/Icons/icon_activitylogs_off.svg'))
        self.history_screen.nav_isLocked.setIcon(QIcon('Assets/Icons/icon_isLocked.svg'))

        # SET MAIN HISTORY RECORDS SCREEN ASSETS
        self.history_screen.hisrec_Button_CitizenHistory.setIcon(QIcon('Assets/Images/img_history_citizen.png'))
