...
class business_func(base_file_func):
    ...
    def show_register_business_popup(self):
        ...
        self.popup = load_popup("UI/PopUp/Screen_Institutions/register_business.ui", self)
        self.popup.setWindowTitle("Mapro: Register New Business")
        self.popup.setFixedSize(self.popup.size())

        self.popup.register_buttonConfirmBusiness_SaveForm.setIcon(QIcon('Assets/FuncIcons/icon_confirm.svg'))
        self.popup.inst_DTIuploadButton.setIcon(QIcon('Assets/Icons/icon_upload_image.png'))
