...
class infrastructure_func(base_file_func):
    ...
    # Set images and icons
        self.inst_infrastructure_screen.btn_returnToInstitutionPage.setIcon(QIcon('Assets/FuncIcons/img_return.png'))
        self.inst_infrastructure_screen.inst_InfraName_buttonSearch.setIcon(QIcon('Assets/FuncIcons/icon_search_w.svg'))
