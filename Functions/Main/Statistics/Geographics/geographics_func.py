...
class geographics_func(base_file_func):
    def __init__(self, login_window, emp_first_name, stack):
        super().__init__(login_window, emp_first_name)
        self.stack = stack
        self.stat_geo_screen = self.load_ui("UI/MainPages/StatisticPages/geographic.ui")
        self.setup_geo_ui()
        self.center_on_screen()

    def setup_geo_ui(self):
        """Setup the Geographics UI layout."""
        self.setFixedSize(1350, 850)
        self.setWindowTitle("MaPro: Geographics")
        self.setWindowIcon(QIcon("Assets/AppIcons/appicon_active_u.ico"))

    # Set images and icons
        self.stat_geo_screen.btn_returnToStatisticsPage.setIcon(QIcon('Assets/FuncIcons/img_return.png'))
