...
class groups_func(base_file_func):
    def __init__(self, login_window, emp_first_name, stack):
        ...
        self.stack = stack
        self.stat_groups_screen = self.load_ui("UI/MainPages/StatisticPages/groups.ui")
    ...
    # Set images and icons
        self.stat_groups_screen.btn_returnToStatisticsPage.setIcon(QIcon('Assets/FuncIcons/img_return.png'))
