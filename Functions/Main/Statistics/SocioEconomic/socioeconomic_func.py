...
class socioeconomic_func(base_file_func):
    def __init__(self, login_window, emp_first_name, stack):
        ...
        self.stack = stack
        self.stat_socioeconomic_screen = self.load_ui("UI/MainPages/StatisticPages/socioeconomic.ui")
        self.setup_socioeconomic_ui()
        self.center_on_screen()

    def setup_socioeconomic_ui(self):
        """Setup the SocioEconomic UI layout."""
        self.setFixedSize(1350, 850)
        self.setWindowTitle("MaPro: SocioEconomic")
        self.setWindowIcon(QIcon("Assets/AppIcons/appicon_active_u.ico"))

    # Set images and icons
        self.stat_socioeconomic_screen.btn_returnToStatisticsPage.setIcon(QIcon('Assets/FuncIcons/img_return.png'))
