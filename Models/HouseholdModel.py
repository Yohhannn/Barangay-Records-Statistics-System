...
class HouseholdModel:
    ...
    def save_household_data(self, household_data):
        ...
        self.connection.execute_with_user("SELECT sitio_id FROM sitio WHERE sitio_name = %s",
        ...
        self.connection.execute_with_user("SELECT toil_id FROM toilet_type WHERE toil_type_name = %s",
        ...
        self.connection.execute_with_user("SELECT water_id FROM water_source WHERE water_source_name = %s",
