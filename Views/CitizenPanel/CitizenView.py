...
class CitizenView:
 ...
 #return_to_part1_from_part2
    ...
    def show_update_citizen_part_01_popup(self, parent):
        ...
        try:
            ...
            combo = self.part1_popup_update.register_citizen_comboBox_Religion
            combo.clear()
            for rel_id, rel_name in results:
                combo.addItem(rel_name, rel_id)
        ...
        return self.part1_popup_update

    def show_update_citizen_part_02_popup(self, parent):
        # part_one_popup.close()
        ...
        self.part2_popup_update.register_buttonReturnToPart1_FromPart2.setIcon(
            QIcon('Resources/Icons/FuncIcons/icon_arrow_prev'))
        self.part2_popup_update.register_buttonConfirmPart2_NextToPart3.setIcon(
            QIcon('Resources/Icons/FuncIcons/icon_arrow_next'))
        self.part2_popup_update.register_buttonConfirmPart2_NextToPart3.clicked.connect(self.controller.update_validate_part2_fields)
        self.part2_popup_update.register_buttonReturnToPart1_FromPart2.clicked.connect(
            self.controller.update_return_to_part1_from_part2)
        try:
            db = Database()
            cursor = db.get_cursor()
            cursor.execute("SELECT es_id, es_status_name FROM employment_status ORDER BY es_status_name ASC;")
            ...
            combo = self.part2_popup_update.register_citizen_comboBox_EmploymentStatus
            combo.clear()
            for es_id, es_status_name in results:
                combo.addItem(es_status_name, es_id)
        ...
        try:
            ...
            combo = self.part2_popup_update.register_citizen_comboBox_PhilCat
            combo.clear()
            for pc_id, pc_category_name in results:
                combo.addItem(pc_category_name, pc_id)
        ...
        return self.part2_popup_update
        # return_to_part1_from_part2

    def show_update_citizen_part_03_popup(self, parent):
        # part_two_popup.close()
        ...
        self.part3_popup_update.register_buttonReturnToPart2_FromPart3.setIcon(
            QIcon('Resources/Icons/FuncIcons/icon_arrow_prev'))
        self.part3_popup_update.register_buttonConfirmPart3_SaveForm.setIcon(QIcon('Resources/Icons/FuncIcons/icon_confirm'))
        self.part3_popup_update.register_buttonConfirmPart3_SaveForm.clicked.connect(self.controller.update_validate_part3_fields)
        self.part3_popup_update.register_buttonReturnToPart2_FromPart3.clicked.connect(
            self.controller.update_return_to_part2_from_part3)

        # if hasattr(self, 'citizen_data'):
        #     self.restore_part3_data()
        # self.setup_radio_button_groups_03()
        # save_btn = self.part3_popup_update.findChild(QPushButton, "register_buttonConfirmPart3_SaveForm")
        # if save_btn:
        #     save_btn.clicked.connect(self.confirm_and_save)
        # back_btn = self.part3_popup_update.findChild(QPushButton, "register_buttonReturnToPart2_FromPart3")
        # if back_btn:
        #     back_btn.clicked.connect(self.return_to_part2_from_part3)
        ...
        try:
            ...
            combo = self.part3_popup_update.register_citizen_comboBox_EducationalLevel
            combo.clear()
            for edat_id, educational_attainment in results:
                combo.addItem(educational_attainment, edat_id)
        ...
        return self.part3_popup_update
    ...
    def setup_profile_ui(self, ui_screen):
        ...
        ui_screen.cp_citizen_button_update.clicked.connect(self.controller.show_update_citizen_part_01_initialize)
